...
class EditJournalModal extends StatefulWidget {
  final JournalModel journal;
  const EditJournalModal({super.key, required this.journal});

  @override
  State<EditJournalModal> createState() => _EditJournalModalState();
}

class _EditJournalModalState extends State<EditJournalModal> {
                    ...
                    child: MainButton(
                        ...
                        onPressed: () {
                          if (_formKey.currentState?.validate() ?? false) {
                            ...
                            // context.read<JournalCubit>().EditJournal(
                            //     date:
